...
# Challenges & Troubleshooting
    This phase involved overcoming several real-world configuration hurdles:
        ...
        .API Connection Policies: Attempted to use Gmail/Outlook connectors for notifications but pivoted to Internal Incident Comments to          bypass cross-tenant authentication restrictions (401 Unauthorized), keeping the workflow entirely within the SOC ecosystem.
